...
import com.dianping.tiger.engine.EventFactory;
...
import com.dianping.tiger.engine.annotation.ExecuteType;
...
public class EventExecutor {
	...
	public EventExecutor(final EventConfig eventConfig,
		...
		if (ScheduleServer.getInstance().getTaskStrategy() == ScheduleConstants.TaskFetchStrategy.Multi
			...
			this.eventConfig.setHandler(handlerName);
		}
		this.eventNavigator = new EventNavigator(handlerName);
